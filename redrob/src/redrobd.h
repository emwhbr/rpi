...
#define REDROBD_THREAD_OPERATION_FAILED    11
#define REDROBD_THREAD_STATE_NOT_OK        12
#define REDROBD_THREAD_STATUS_NOT_OK       13
#define REDROBD_UNEXPECTED_EXCEPTION       14
