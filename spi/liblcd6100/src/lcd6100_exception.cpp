...
*
****************************************************************************/
lcd6100_exception::lcd6100_exception(const char *file,
				     int line,
...
*
****************************************************************************/
lcd6100_exception::~lcd6100_exception(void) throw()
{
}
...
*
****************************************************************************/
void lcd6100_exception::get_stack_frames(STACK_FRAMES &frames)
{
  unsigned i = 0;
...
string lcd6100_exception::get_class_method(const string pretty_function)
{
