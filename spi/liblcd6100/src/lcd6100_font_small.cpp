...
const uint8_t lcd6100_font_small::m_font_table[FONT_SMALL_NR_CHARS][FONT_SMALL_BYTES_PER_CHAR] = {
  ...
  {0x70,0xD8,0xD8,0x70,0x00,0x00,0x00,0x00}  // DEL  0x7f
};
...
lcd6100_font_small::lcd6100_font_small(void)
{
  m_height = 8;
  m_width  = 6;
  m_bytes_per_char = FONT_SMALL_BYTES_PER_CHAR;
}
...
const uint8_t* lcd6100_font_small::get_font_table(char c)
{
  if ( (c >= 0x20) && (c <= 0x7f) ) {
