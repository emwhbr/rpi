...
*
****************************************************************************/
raspi_exception::raspi_exception(const char *file,
				 int line,
...
*
****************************************************************************/
raspi_exception::~raspi_exception(void) throw()
{
}
...
*
****************************************************************************/
string raspi_exception::get_function(void)
{
...
*
****************************************************************************/
void raspi_exception::get_stack_frames(STACK_FRAMES &frames)
{
  unsigned i = 0;
...
string raspi_exception::get_class_method(const string pretty_function)
{
